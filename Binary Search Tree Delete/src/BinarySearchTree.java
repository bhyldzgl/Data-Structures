public class BinarySearchTree {
    ...
    private Node deleteRecursive(Node current,int number){
         if( current == null ){
             return current;
         }
         else if ( current.data > number){
             current.leftChild = deleteRecursive(current.leftChild, number);
         }
         else if( current.data < number ){
             current.rightChild = deleteRecursive(current.rightChild, number);
         } else {
